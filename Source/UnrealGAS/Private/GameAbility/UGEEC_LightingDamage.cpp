...
#include "GameAbility/UGEEC_LightingDamage.h"
...
struct FLightningDamageStatics
{
	...
	FLightningDamageStatics()
	{
		...
		DEFINE_ATTRIBUTE_CAPTUREDEF(UCharacterAttributeSet, CriticalRate, Source, true);
	}
};
...
UUGEEC_LightingDamage::UUGEEC_LightingDamage()
{
...
void UUGEEC_LightingDamage::Execute_Implementation(const FGameplayEffectCustomExecutionParameters& ExecutionParams, FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
